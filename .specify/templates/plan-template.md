...
- [ ] **I. Teach, Don't Ghostwrite** — feature deepens learner understanding;
      does not generate code the learner hasn't asked to understand.
- [ ] **II. Meet the Learner Where They Are** — anchors new concepts to the
...
- [ ] **IV. Specs Before Code** — a spec-kit spec backs this work.
- [ ] **V. Small, Shippable Increments** — slices leave `main` npm-publishable;
      no dark launches.
